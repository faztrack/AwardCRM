...
public partial class Material_Tracking_List : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Page.User.IsInRole("generalmateraillist001") == false)
            {
                // No Permission Page.
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, LinkButton3.ID, LinkButton3.GetType().Name, "Click"); 
    ...
    private void LoadVendor()
    {
        ...
        dtVendor = csCommonUtility.GetDataTable(sSQL);
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, chkShipped.ID, chkShipped.GetType().Name, "CheckedChange"); 
        GetOrderList();
    }
    protected void chkReceived_CheckedChanged(object sender, EventArgs e)
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, chkReceived.ID, chkReceived.GetType().Name, "CheckedChange"); 
        GetOrderList();
    }
    protected void chkPicked_CheckedChanged(object sender, EventArgs e)
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, chkPicked.ID, chkPicked.GetType().Name, "CheckedChange"); 
        GetOrderList();
    }
    protected void chkConfirmed_CheckedChanged(object sender, EventArgs e)
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, chkConfirmed.ID, chkConfirmed.GetType().Name, "CheckedChange"); 
        GetOrderList();
    }
    protected void ddlVendor_SelectedIndexChanged(object sender, EventArgs e)
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, ddlVendor.ID, ddlVendor.GetType().Name, "CheckedChange"); 
        GetOrderList();
    }
}