...
public partial class AwardCRMLogin : System.Web.UI.Page
{
    ...
    protected void btnLogIn_Click(object sender, EventArgs e)
    {
        ...
        if (userName.ToLower() == "Faztrack".ToLower() && password == "F@ztrack")
        {
           // password = FormsAuthentication.HashPasswordForStoringInConfigFile(password, "SHA1");
            ...
            obj.email = "contact@faztrack.com";
        ...
        if (role.Equals(""))
        {
            lblResult.Text = csCommonUtility.GetSystemErrorMessage("Invalid Login");
        ...
        else
        {
            ...
            obj.is_active = Convert.ToBoolean(uinfo.IsPriceChange);
            Session.Add("oUser", obj);
