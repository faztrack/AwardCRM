<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="leadlist_Old.aspx.cs"
    Inherits="leadlist_Old" Title="Lead List" %>
                                    ...
                                    <ItemTemplate>
                                        <div style="width: 100%;">
                                            <div class="divToolsLeft">
                                                <asp:HyperLink ID="hypMessage" runat="server"><img width="25" height="25" src="images/01_message_center.png" alt="Message Center" title="Message Center" /></asp:HyperLink>
                                                <asp:HyperLink ID="hyp_ProjectNotes" runat="server"><img width="25" height="25" src="images/07_eq.png" alt="Project Notes" title="Project Notes" /></asp:HyperLink>
                                                <asp:HyperLink ID="hyp_CallLog" runat="server"><img width="25" height="25" src="images/08_call_log.png" alt="Activity Log" title="Activity Log" /></asp:HyperLink>                                               
                                                <asp:HyperLink ID="hyp_DocumentManagement" runat="server"><img width="25" height="25" src="images/11_Document.png" alt="Document Management" title="Document Management" /></asp:HyperLink>
                                            </div>
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="7%" />
