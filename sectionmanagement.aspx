<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="sectionmanagement.aspx.cs"
    Inherits="sectionmanagement" Title="Section Management" %>
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td align="left" colspan="2" valign="top">
                                                <asp:GridView ID="grdItemPrice" runat="server" AutoGenerateColumns="False" DataKeyNames="item_id"
                                                    OnRowEditing="grdItemPrice_RowEditing" CssClass="mGrid">
                                                    <Columns>
                                        ...
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:CheckBox ID="chkNewSection" runat="server" OnCheckedChanged="chkNewSection_CheckedChanged"
                                                    Text="New Section" AutoPostBack="True" />
                                                <asp:CheckBox ID="chkNewSubSection" runat="server" OnCheckedChanged="chkNewSubSection_CheckedChanged"
                                                    Text="New Sub Section" AutoPostBack="True" />
                                                <asp:CheckBox ID="chkNewItem" runat="server" OnCheckedChanged="chkNewItem_CheckedChanged"
                                                    Text="New Item" AutoPostBack="True" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                ...
                                                <asp:Panel ID="pnlItem" runat="server">
                                                    <table style="width: 100%;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:RadioButtonList ID="rdoLabor" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rdoLabor_SelectedIndexChanged"
                                        ...
                                        <tr>
                                            <td align="center" colspan="2">
                                                &nbsp;<asp:Button ID="btnSave" runat="server" Text="Update" TabIndex="3" OnClick="btnSave_Click" />
    ...
    <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="1" AssociatedUpdatePanelID="UpdatePanel1"
        ...
        <ProgressTemplate>
            ...
            <div class="overlayContent">
                <p>
                    Please wait while your data is being processed</p>
