...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        //------On Page Load-----
        $(function () {
            $('.csstComments').keypress(function (e) {
                console.log(this.id);
                //debugger;

                var tId = this.id;
                // var pId = tId.replace("txtComments", "pComments");

                var tval = $('#' + tId).val(), tlength = tval.length, set = 10, remain = parseInt(set - tlength);

                // $('#' + pId).text(remain);

                if (remain <= 0 && e.which !== 0 && e.charCode !== 0) {
                    $('#' + tId).val((tval).substring(0, tlength - 1))
                }
            });
            $('.csstComments').blur(function (e) {
                console.log(this.id);
                //   debugger;
                ...
                var tval = $('#' + tId).val(), tlength = tval.length, set = 1000, remain = parseInt(set - tlength);
                ...
                if (tlength > set) {
                    ...
                    alert('Maximum length exceeded, Comments max length Up to ' + set + ' Characters.');//\nCurrent length is: ' + tval.length

                    // $('#' + tId).val((tval).substring(0, set));
                }
            });
        });
        ...
        <tr>
            <td align="center" valign="top">
                <div style="margin: 0 auto; width: 100%">
                            ...
                            <table width="100%" border="0" cellspacing="4" cellpadding="4" align="center">
                                        ...
                                        <table class="wrapper" width="100%">
                                            <tr>
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="height: 18px;" align="left" valign="top">
                                                                ...
                                                                <asp:Button ID="btnTemplateEstimate" Width="210" runat="server" OnClick="btnTemplateEstimate_Click" Text="Save this Estimate as a Template" ToolTip="Click here to Save this Estimate as a Template" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <td align="left" valign="top">
                                                    <table>
                                                        <tr>
                                                            <td style="width: auto;" align="left" valign="middle">&nbsp;</td>
                                                            <td style="width: auto;" align="left" valign="middle">
                                                                <asp:CheckBox ID="chkCashPay" runat="server" AutoPostBack="True" OnCheckedChanged="chkCashPay_CheckedChanged" Text="Cash Payment" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: auto;" align="left" valign="middle">
                                                            ...
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td align="left" valign="middle">
                                                                            <asp:Button ID="btnPricingPrintWOPrice" runat="server" CssClass="button" OnClick="btnPricingPrintWOPrice_Click" Text="Print w/o Price" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <asp:GridView ID="grdItemPrice" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Short Notes">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtShortNote" runat="server" MaxLength="500" TextMode="MultiLine" Width="280px"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Unit Price">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblUnitPrice" runat="server" Text='<%# Eval("item_cost","{0:c}").ToString() %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Labor Rate">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblaborPrice" runat="server" Text='<%# Eval("LaborUnitCost","{0:c}").ToString() %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                <ItemStyle HorizontalAlign="Right" />
                                                            </asp:TemplateField>
                                                ...
                                                <td align="left" valign="top">
                                                    <table class="tabGrid" width="100%" cellpadding="0" cellspacing="0" id="tdlOther" runat="server" height="auto" visible="True">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="tabGridtd">
                                                                <asp:TextBox ID="txtO_ShortNotes" runat="server" TextMode="MultiLine" MaxLength="500" Width="280px"></asp:TextBox>
                                                            </td>
                                                ...
                                                <td colspan="2">
                                                    <asp:GridView ID="grdItemPriceAll" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Short Notes">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtShortNote" CssClass="csstComments" runat="server" TextMode="MultiLine" Width="95%" Height="50%"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                <ItemStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:GridView ID="grdRecentlyAdded" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                                        DataKeyNames="item_id" PageSize="200"
                                                        TabIndex="2" Width="100%" OnRowDeleting="grdRecentlyAdded_RowDeleting" OnRowDataBound="grdRecentlyAdded_RowDataBound">
                                                        <Columns>
                                    ...
                                    <td align="center">
                                        <table id="tblTotalProjectPrice" runat="server" cellpadding="8" cellspacing="0" style="border: 1px solid #c0c0c0;"
                                            ...
                                            <tr id="trCash" runat="server">
                                                <td colspan="3" style="border: 1px solid #c0c0c0;" align="center">
                                                    <asp:Label ID="lblCashMsg" runat="server" Text="** Prices shown are with cash terms discount" ForeColor="RoyalBlue"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding: 0px; margin: 0px;">
                                                                                <asp:LinkButton ID="lnkAddLocNotes" runat="server" CssClass="addNote" CommandName="AddNotes"
                                                                                    CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' Text="Add Notes"></asp:LinkButton></td>
                                                                            <td style="padding: 0px; margin: 0px;">
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                         <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click"
                                            Text="Delete Estimate" CssClass="button" Style="color: red !important; border: 1px solid red;" />
                                        ...
                                        <asp:Button ID="btnCheckMandatory" runat="server" CssClass="button" OnClick="btnCheckMandatory_Click" Text="Check Mandatory" Visible="False" />
                                        ...
                                        <asp:LinkButton ID="lnkDummy6" runat="server"></asp:LinkButton>
                                ...
                                <tr>
                                    <td align="left" valign="top">
                                        ...
                                        <cc1:ModalPopupExtender ID="ModalPopupExtender6" TargetControlID="lnkDummy6" BackgroundCssClass="modalBackground"
                                            CancelControlID="btnCloseMandatory" PopupControlID="pnlMandatoryItem"
                                            runat="server">
                                        </cc1:ModalPopupExtender>
                                        <cc1:ModalPopupExtender ID="ModalPopupExtender3" TargetControlID="lnkDummy4" BackgroundCssClass="modalBackground"
                                                ...
                                                <tr>
                                                    <td align="center" colspan="2">
                                                        <asp:GridView ID="grdDeletedItem" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                                            DataKeyNames="item_id" PageSize="200"
                                                            TabIndex="2" Width="100%" OnRowDataBound="grdDeletedItem_RowDataBound">
                                                            <Columns>
                                                                <asp:BoundField DataField="item_id" HeaderText="Item Id" ReadOnly="True">
                                                                    <HeaderStyle Width="5%" />
                                                                </asp:BoundField>
                    ...
                    <asp:Panel ID="pnlMandatoryItem" runat="server" Style="width: auto; height: auto;" BackColor="Snow">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <table cellpadding="0" cellspacing="2" width="98%">
                                                <tr>
                                                    <td align="center">
                                                        <b>Following Mandatory items are missing in pricing.</b>
                                                    </td>

                                                </tr>
                                                <tr>
                                                    <td align="center">
                                                        <b>Upon clicking on confirm those Item(s) will be added in pricing, Do you Authorize this add ? </b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" colspan="2">
                                                        <asp:GridView ID="grdMandatoryItem" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                                            DataKeyNames="item_id" PageSize="200"
                                                            TabIndex="2" Width="99%" OnRowDataBound="grdMandatoryItem_RowDataBound">
                                                            <Columns>
                                                                <asp:BoundField DataField="item_id" HeaderText="Item Id" />
                                                                <asp:BoundField HeaderText="Section Name">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                ...
                                                                <asp:TemplateField HeaderText="Location">
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList ID="ddlLocation1" runat="server" DataValueField="location_id" DataTextField="location_name" DataSource="<%#dtLcation %>">
                                                                        </asp:DropDownList>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                ...
                                                <tr>
                                                    <td align="center">&nbsp;<asp:Button ID="btnAddMandatory" runat="server" Text="Confirm" TabIndex="2"
                                                        CssClass="button" OnClick="btnAddMandatory_Click" />
                                                        &nbsp;<asp:Button ID="btnCloseMandatory" runat="server" Text="Cancel" TabIndex="3" Width="80px"
                                                            CssClass="button" />
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td align="center">
                                            <table cellpadding="0" cellspacing="2" width="98%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox
                                                            ID="txtDisplayn" runat="server" CssClass="textBoxNone" Font-Bold="True"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtLocationNotes" runat="server"
                                                            ...
                                                            onkeydown="checkTextAreaMaxLengthWithDisplay(this,event,'1000',document.getElementById('head_txtDisplayn'));"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" colspan="2">
