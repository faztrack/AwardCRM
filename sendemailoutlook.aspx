            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtTo" 
                     ...
                     <%--<cc:TextBoxWatermarkExtender ID="wtmFileNumber" runat="server" TargetControlID="txtTo" WatermarkText="" />--%>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtBcc"
                        runat="server" CssClass="textBox" Width="445px" MaxLength="100"></asp:TextBox></td>
                <%-- <cc:TextBoxWatermarkExtender ID="wtmBcc" runat="server" TargetControlID="txtBcc" WatermarkText="" />--%>
            </tr>
            <tr>
