                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <table style="padding: 0px; margin: 0px;">
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:DropDownList ID="ddlInstaller" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlInstaller_SelectedIndexChanged" Width="140px">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <table style="padding: 0px; margin: 0px;">
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:DropDownList ID="ddEmployee" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddEmployee_SelectedIndexChanged" Width="140px">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td>
