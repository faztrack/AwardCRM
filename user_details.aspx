                        ...
                        <table id="Table2" width="98%" align="center" border="0" cellpadding="0" cellspacing="3" onclick="return TABLE1_onclick()">
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="2">
                                    ...
                                    <asp:CheckBox ID="chkEmailIntegrationType" runat="server" TabIndex="9" Checked="false" AutoPostBack="true" OnSelectedIndexChanged="chkEmailIntegrationType_SelectedIndexChanged" OnCheckedChanged="chkEmailIntegrationType_CheckedChanged" Text="Outlook/Exchange"></asp:CheckBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
