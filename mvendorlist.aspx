                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading panel-heading-ext">
                            ...
                            <h3 class="panel-title">
                                <asp:ImageButton ID="imgBack" runat="server" OnClick="imgBack_Click" ImageUrl="~/assets/mobileicons/back_header_vendor_list.png" Style="margin-bottom: -10px;height:32px;" />
                                ...
                                <div class="col-lg-4 col-sm-6 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            ...
                                            <asp:TextBox ID="txtSearch" CssClass="form-control form-control-ext" runat="server" TabIndex="2" onkeypress="return searchKeyPress(event);" style="width:135px"></asp:TextBox>
                                        ...
                                        <cc1:TextBoxWatermarkExtender ID="wtmFileNumber" runat="server" TargetControlID="txtSearch"
                                            WatermarkText="Search by Vendor" />
                                    </div>
