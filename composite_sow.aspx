                                            ...
                                            <tr style="padding: 0px; margin: 0px;">
                                                ...
                                                <td style="padding: 0px; margin: 0px;">&nbsp;</td>
                                                 <td style="padding-left: 10px;" align="left" valign="middle">
                                                    <asp:ImageButton ID="btnExpCostLocList" runat="server" CssClass="imageBtn" ImageUrl="~/images/export_csv.png" OnClick="btnExpCostLocList_Click" ToolTip="Export in CSV" />
                                                </td>
                                                <td style="padding: 0px; margin: 0px;">
