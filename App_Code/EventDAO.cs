...
public class EventDAO
{
    ...
    public static int updateEvent(int id, String title, String section, String location, String description, DateTime start, DateTime end, int empId, string empName,
        int child_event_id, int dependencyType, int offsetDays, int parentDependencyType, int parentOffsetDays, string linkType, int custId, int estId, bool IsScheduleDayException, bool IsComplete)
    {
        DataClassesDataContext _db = new DataClassesDataContext();
        int nTypeId = 0;
        int nCheck = 0;
        ...
        if (System.Web.HttpContext.Current.Session["TypeID"] != null)
        {
            ...
            if (nTypeId == 1) // Operation Calendar
            {
                ...
                nCheck = UpdateOnlineSchedule(id, strTitle, strSection, location.Replace("'", "''"), description.Replace("'", "''"), dtStart, dtEnd, nEmployeeID, strEmployeeName, child_event_id, dependencyType, offsetDays, parentDependencyType, parentOffsetDays, linkType, ncid, neid, nDuration, strUName, nOffsetDays, IsScheduleDayException, IsComplete);
                ...
                string sql = "UPDATE ScheduleCalendarTemp SET title='" + strTitle + "', section_name='" + strSection + "', location_name='" + location.Replace("'", "''") + "', description='" + description.Replace("'", "''") + "', " +
                            " event_start='" + dtStart + "', event_end='" + dtEnd + "',  duration='" + nDuration + "', employee_id='" + nEmployeeID + "',  employee_name='" + strEmployeeName + "', " +
                            " last_updated_by='" + strUName + "', last_updated_date='" + DateTime.Now + "', is_complete='" + Convert.ToInt32(IsComplete) + "', IsScheduleDayException=" + Convert.ToInt32(IsScheduleDayException) + " " +
            ...
            else
            {
                ...
                try
                {
                    ...
                    string sql = "UPDATE ScheduleCalendar SET title='" + strTitle + "', section_name='" + strSection + "', location_name='" + location.Replace("'", "''") + "', description='" + description.Replace("'", "''") + "', " +
                               " event_start='" + dtStart + "', event_end='" + dtEnd + "',  duration='" + nDuration + "', employee_id='" + nEmployeeID + "',  employee_name='" + strEmployeeName + "', is_complete='" + Convert.ToInt32(IsComplete) + "', " +
    ...
    public static int updateEventTime(int id, DateTime start, DateTime end, int customer_id, int estimate_id, bool IsScheduleDayException)
    {
        ...
        if (System.Web.HttpContext.Current.Session["TypeID"] != null)
        {
            nTypeId = (int)System.Web.HttpContext.Current.Session["TypeID"];
            {
                ...
                else
                {
                    ...
                    string sql = "UPDATE ScheduleCalendar SET  event_start='" + start + "', event_end='" + end + "' WHERE event_id=" + id + " AND type_id = " + nTypeId + strCondition;
                    _db.ExecuteCommand(sql, string.Empty);
    ...
    public static void updateEventTimeAll(int id, DateTime start, DateTime end, int customer_id, int estimate_id)
    {
        ...
        {
            string sql = "UPDATE ScheduleCalendarTemp SET  event_start='" + start + "', event_end='" + end + "' WHERE event_id=" + id + " AND customer_id =" + ncid + " AND estimate_id = " + neid;
            _db.ExecuteCommand(sql, string.Empty);
        }
    ...
    public static void UpdateEventNotes(int id, DateTime start, DateTime end, string operation_notes)
    {
        ...
        string sql = "UPDATE ScheduleCalendarTemp SET event_start='" + start + "', event_end='" + end + "',  operation_notes='" + operation_notes + "' WHERE event_id=" + id + " AND customer_id =" + ncid + " AND estimate_id = " + neid;
    ...
    private static int UpdateOnlineSchedule(int id, String title, String section, String location, String description, DateTime start, DateTime end, int empId, string empName,
        int child_event_id, int dependencyType, int offsetDays, int parentDependencyType, int parentOffsetDays, string linkType, int ncid, int neid, int nDuration, string strUpdatedBy, int nOffsetDays, bool IsScheduleDayException, bool IsComplete)
    {
        int nCheck = 0;
        DataClassesDataContext _db = new DataClassesDataContext();
        ...
        string sql = "UPDATE ScheduleCalendar SET title='" + title + "', section_name='" + section + "', location_name='" + location.Replace("'", "''") + "', description='" + description.Replace("'", "''") + "', " +
                    " event_start='" + start + "', event_end='" + end + "',  duration='" + nDuration + "', employee_id='" + empId + "',  employee_name='" + empName + "', " +
                    " last_updated_by='" + strUpdatedBy + "', last_updated_date='" + DateTime.Now + "', is_complete='" + Convert.ToInt32(IsComplete) + "', IsScheduleDayException=" + Convert.ToInt32(IsScheduleDayException) + " " +
                    " WHERE event_id=" + id + " AND customer_id =" + ncid + " AND estimate_id = " + neid;
