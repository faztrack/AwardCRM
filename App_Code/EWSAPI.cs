...
public class EWSAPI
{
    ...
    {
        ExchangeService service = new ExchangeService(ExchangeVersion.Exchange2013);
        service.Credentials = new WebCredentials("bryan@awardkb.com", "381fxoBO!");
        //service.Url = new Uri("https://outlook.office365.com/EWS/Exchange.asmx");
        service.AutodiscoverUrl("bryan@awardkb.com", CallbackMethods.RedirectionUrlValidationCallback);
        return service;
