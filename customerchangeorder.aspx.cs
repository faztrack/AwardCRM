...
public partial class customerchangeorder : System.Web.UI.Page
{
    ...
    protected void btnAcceptDOWN_Click(object sender, EventArgs e)
    {
        ...
        if (strToEmail.Length > 4)
        {
            ...
            string strUser = "";
            string strFrom = "";//"info@awardkb.com", "AwardKB (system msg: do not reply)"
            int ProtocolType = 1;
    ...
    private void SendEmailToCustomer(int nCustomerId, decimal amount, string strTerms, string strPMName, string strCCNum)
    {
        ...
        string strTable = "<table align='center' width='704px' border='0'>" + Environment.NewLine +
                ...
                "<tr><td align='left'></td></tr><tr><td align='left'></td></tr>" + Environment.NewLine +
                "<tr><td align='left'>Please click <a target='_blank' href='https://awardkb.faztrack.com/customerlogin.aspx'> here </a> to view your current project status.</td></tr>" + Environment.NewLine +
                "<tr><td align='left'></td></tr><tr><td align='left'></td></tr>" + Environment.NewLine +
        ...
        if (strToEmail.Length > 4)
        {
            ...
            customeruserinfo obj = new customeruserinfo();
            string strUser = "";
            string strFrom = "";//"info@awardkb.com"
            int ProtocolType = 1;
            ...
            if (strCCEmail.Length > 4)
                email.CC = strCCEmail;
            email.BCC = "mdshohidullah.2010@gmail.com, tislam@faztrack.com";
            // email.BCC = strCCEmail;

            email.Subject = "Your payment with Award KB";
        ...
        try
        {
            ...
            if (Convert.ToDecimal(lblAmountC.Text.Replace("$", "").Replace("(", "-").Replace(")", "")) <= 0)
            {
                ...
                if (strToEmail.Length > 4)
                {
                    ...
                    customeruserinfo obj = new customeruserinfo();
                    string strUser = "";
                    string strFrom = "";//"info@awardkb.com", "FazTimate (system msg: do not reply)"
                    int ProtocolType = 1;
