...
public partial class rc_customer : System.Web.UI.Page
{
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, checkBoxes1.ID, checkBoxes1.GetType().Name, "SelcetedIndexChanged"); 
        string nColmns = "";
        int count = 0;
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, grdCustomerReport.ID, grdCustomerReport.GetType().Name, "PageIndexChangin"); 
        string nColmns = "";
