<%@ Page Language="C#" AutoEventWireup="true" CodeFile="image_gallery_New.aspx.cs" Inherits="image_gallery_New" %>
                ...
                <tr>
                    <td colspan="2" align="center">
                       <table class="wrapper" width="100%">
                            <tr >
                                <%--<td style="text-align: left; color:#000000; font-weight:bold; "><asp:Label ID="lblImageGalleryTitle" runat="server" Visible="false">Image Gallery:</asp:Label>                                  
                                </td>--%>
                            </tr>
                            <tr>
                                                    ...
                                                    <div class="clearfix">
                                                        <div class="divImageCss">
                                                            <asp:HyperLink ID="hypImage" runat="server" CssClass="hypimgCss" data-imagelightbox="g" data-ilb2-caption="">
                                                                <asp:Image ID="img" onerror="this.src='Images/No_image_available.jpg';" runat="server" CssClass="imgCss blindInput" /><br />
