...
public partial class material_traknig : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Page.User.IsInRole("materaillist001") == false)
            {
                // No Permission Page.
    ...
    private void LoadSectionSec()
    {
        ...
        dtSection = csCommonUtility.GetDataTable(sSQL);
    ...
    private void LoadVendor()
    {
        ...
        ddlVendor.DataSource =csCommonUtility.GetDataTable(sSQL);
    ...
    private void resetsave()
    {
        ...
        //PaneTrackingInfo.Visible = false;
        //PanelReceived.Visible = false;
        //PanelPicked.Visible = false;
    ...
    protected void EditSelection(object sender, EventArgs e)
    {
        ...
        //txtSelectionDate.Visible = false;
        //imgSelectionDate.Visible = false;
