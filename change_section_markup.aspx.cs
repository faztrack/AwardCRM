...
public partial class change_section_markup : System.Web.UI.Page
{
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, chkNewItem.ID, chkNewItem.GetType().Name, "CheckedChanged"); 
        if (chkNewItem.Checked)
        {
            btnSave.Text = "Save";
            chkNewSubSection.Checked = false;
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, chkNewSection.ID, chkNewSection.GetType().Name, "CheckedChanged"); 
        if (chkNewSection.Checked)
        {
            btnSave.Text = "Save";
            lblResult.Text = "";
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, rdoLabor.ID, rdoLabor.GetType().Name, "SelectedIndexChanged"); 
        if (rdoLabor.SelectedValue == "1")
        {
            //txtLabor.Text = "0";
            lblLabor0.Visible = false;
