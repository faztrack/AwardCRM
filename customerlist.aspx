                                                ...
                                                <ul style="list-style-type: none; margin: 0; padding: 0;">
                                                    <li>
                                                        <ul style="float:left;">
                                                            ...
                                                            <li style="float: left;"></li>
                                                            <li style="float: left;">
                                                                <asp:HyperLink ID="hyp_jstatus" style="display:none;" runat="server"><img src="images/system_icons/04_icon.png" alt="Job Status Graphics" title="Job Status Graphics" /></asp:HyperLink></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </div>
