                        ...
                        <td align="center" valign="top" width="50%">
                            <div id="SignaturePadCustome" class="m-signature-pad">
                                ...
                                <div class="m-signature-pad--footer">
                                    <asp:Button ID="btnSaveSignature" Text="Save Signature" runat="server" CssClass="btnGrayBlu" data-action="save1" OnClick="btnSaveSignature_Click" Width="150px" OnClientClick="ShowProgress();" />
                                    <asp:Button ID="btnClearSignature" runat="server" Text="Clear" data-action="clear1" CssClass="btnRed" Width="150px" OnClick="btnClearSignature_Click" />
                                </div>
                            </div>
                        </td>
                                    ...
                                    <td align="center">
                                        ...
                                        <asp:GridView ID="grdSelection" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Check to select">
                                                   <%-- <HeaderTemplate>
