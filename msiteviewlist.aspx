                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-md-11" style="text-align: center;">
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-success" TabIndex="23" Text="Save" Width="80px" OnClick="btnSubmit_Click"  />
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading panel-heading-ext">
                            ...
                            <table width="100%">
                                <tr>
                                     <td align="left">
                                          <asp:ImageButton ID="imgBack" runat="server" OnClick="imgBack_Click" ImageUrl="~/assets/mobileicons/back_header_site_review_list.png" Style="margin-bottom: -10px;height:30px;" />
                                     </td>
                                    <td>
                                          
                                            &nbsp;<asp:Label ID="lblCustomerLastName" runat="server" Text="" Font-Bold="true"></asp:Label>
                                    ...
                                    <table width="100%">
                                                ...
                                                <table cellpadding="0" cellspacing="0" style="padding: 0px; margin: 0px;" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            ...
                                                            <asp:ImageButton ID="imgStartDate" runat="server" CssClass="nostyleCalImg" ImageUrl="~/images/calendar_end.png" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <table cellpadding="0" cellspacing="0" style="padding: 0px; margin: 0px;" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            ...
                                                            <asp:ImageButton ID="imgEndDate" runat="server" CssClass="nostyleCalImg" ImageUrl="~/images/calendar_end.png" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="text-center" width="100%">
                                                <table cellpadding="0" cellspacing="0" style="padding: 0px; margin: 10px 0 0 0;" width="100%">
                                                    <tr>
                                                        
                                                        <td align="right">
                                                            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-default2" OnClick="lnkViewAll_Click">Reset</asp:LinkButton>
                                                        </td>
                                                        <td>&nbsp;
                                                        </td>
                                                        <td>&nbsp;</td>
