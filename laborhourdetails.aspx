                    ...
                    <td>
                        <table id="Table2" width="98%" align="center" border="0" cellpadding="0" cellspacing="3" onclick="return TABLE1_onclick()">
                            ...
                            <asp:Panel ID="pnlCrew" runat="server" Visible="true">
                                <tr>
                                    <td width="40%" align="right">
                                        <span class="required">* </span><b>Crew Member Name: </b>
                                    </td>
                                    <td align="left">
                            ...
                            <asp:Panel ID="pnlEmployee" runat="server" Visible="false">
                                <tr>
                                    <td width="40%" align="right">
                                        <span class="required">* </span><b>Employee Name: </b>
                                    </td>
                                    <td align="left">

                                        <asp:DropDownList ID="ddEmployee" runat="server" CssClass="form-control" TabIndex="2"></asp:DropDownList>
                                    </td>
