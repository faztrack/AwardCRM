...
public partial class GeneralSelectionReview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Page.User.IsInRole("GlobalSelection001") == false)
            {
                // No Permission Page.
    ...
    private void GetSectionSelections()
    {
        try
        {
            ...
            strQ = " select customers.last_name1+', '+first_name1 as customer_name,SectionSelectionID, customers.customer_id, estimate_id, section_id, section_name, location_id, location_name, Title, Price, Section_Selection.Notes, LastUpdateDate, UpdateBy, isSelected, Section_Selection.customer_signature, customer_siignatureDate, customer_signedBy, CreateDate, ValidTillDate, CreatedBy, UserEmail from Section_Selection "+
