<%@ Page Language="C#" MasterPageFile="~/madminlogin.master" AutoEventWireup="true" CodeFile="mobile.aspx.cs" Inherits="mobile" Title="Award CRM" %>
        ...
        <tr>
            <td align="center">
                <table width="60%">
                    ...
                    <tr>
                        <td class="sealWidth" style="padding: 0 15px 0 0; width: 64px;"></td>
                        <td align="right">
