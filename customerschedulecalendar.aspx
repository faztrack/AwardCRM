    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="2" width="100%" align="center">
            ...
            <tr>
                <td style="padding: 0px; margin: 0px; width: 18%;" valign="top"></td>
                <td valign="top" align="center" style="padding: 0px; margin: 0px; width: 60%;">
                    <p class="noteYellow">The calendar is subject to change at any time. Flashing items are yet to be scheduled. You will be notified via SMS text msg the evening before the scheduled event.</p>
                </td>
                <td></td>
            </tr>
            <tr>
