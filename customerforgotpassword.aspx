<%@ Page Language="C#" MasterPageFile="~/customerlogin.master" AutoEventWireup="true" CodeFile="customerforgotpassword.aspx.cs" Inherits="customerforgotpassword" Title="Password Reset" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <div style="position: relative; background-image: url('./assets/loginbg0.jpg'); background-repeat: no-repeat; background-position: center top; font-family: Tahoma, Arial, sans-serif; -webkit-background-size: 100%; -moz-background-size: 100%; -o-background-size: 100%; background-size: 100%;" id="loginTop50">
        <div>&nbsp;</div>
        <div style="margin: 10% auto; background-color: #fff; width: 480px; padding: 20px; border-radius: 10px; opacity: .9; min-height: 440px; box-shadow: 0 0 3px #aaa;">
            <div id="header">
                <table width="100%">
                    <tr>
                        <td align="center">
                            <img style="margin: 0 auto;" width="300px" src="assets/login_logo.png" title="Login" alt="Award KB" />
                        </td>
                    </tr>
                </table>
            </div>
            <div style="max-width: 350px; min-width: 320px; margin: 0 auto;" id="box">
                ...
                <p class="main" style="margin: 5px 0;">
                    <asp:Label ID="lblQuestion" runat="server" Text=""></asp:Label>
                </p>
                <p class="main">
                    <asp:TextBox ID="txtAnswer" Width="98%" runat="server" title="Enter Answer" CssClass="tooltip" TabIndex="2"></asp:TextBox>
                </p>
                            ...
                            <tr>
                                <td align="center" valign="top">
                                    <table cellpadding="0" cellspacing="10">
                                        <tr>
                                            <td>
                                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" TabIndex="2" CssClass="login" /></td>
                                            <td>
                                                <asp:Button ID="btngotoLogin" runat="server" Text="Go to Login" OnClick="btngotoLogin_Click" TabIndex="3" CssClass="login" />
                                            </td>
                                            <td>
                                                <asp:Button ID="btnReset" runat="server" Text="Reset Password" OnClick="btnReset_Click" TabIndex="2" CssClass="login" Visible="false" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <p class="main">
                    <table style="padding: 20px 0; background-color: #fff;" align="center" width="100%">
                        <tr>
                            ...
                            <td style="padding: 0 10px 0 24px;" align="right" valign="bottom">
