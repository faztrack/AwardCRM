...
public partial class SelectionSheetNew : System.Web.UI.Page
{
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, btnAddItemKitchen.ID, btnAddItemKitchen.GetType().Name, "Click"); 
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, btnAddKitchenTileItem.ID, btnAddKitchenTileItem.GetType().Name, "Click"); 
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, customerMenuTab.ID, customerMenuTab.GetType().Name, "MenuItemClick"); 
