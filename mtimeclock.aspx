...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA6TSREURsg3auq7IP_bxgrl0Q_yHJPHc0"
    ...
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-ext">
            ...
            <h3 class="panel-title">
                <asp:ImageButton ID="imgBack" runat="server" OnClick="imgBack_Click" ImageUrl="~/assets/mobileicons/back_header_time_clock.png" Style="margin-bottom: -10px; height:32px;" />
            </h3>
        </div>
                                ...
                                <div class="row">
                                    <div>
                                        <div class="text-center">
                                            <span style="font-weight: bold; font-size:16px; color: #1574c4;">Date:</span>
                                            <asp:Label ID="lblDateTime" runat="server" Font-Size="16px" Text="" Font-Bold="true"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    <td align="center" class="cssHeader">
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td style="padding: 10px;" align="center"><span class="titleNu"><span id="spnPnlSection" class="cssTitleHeader">
                                                                    ...
                                                                    <font class="myHours">My Hours</font></span></span>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-6 col-md-12">
                            <div class="input-group" style="margin-top: 30px;">
                                <asp:TextBox ID="txtSearch" CssClass="form-control input-lg mobileTextFiled" runat="server" TabIndex="2" onkeypress="return searchKeyPress(event);"></asp:TextBox>
                                <span class="input-group-btn">
                                    <asp:LinkButton ID="btnSearch" runat="server" CssClass="btn btn-default btn-lg"
                    ...
                    <div class="row">
                        <div class="ol-lg-12  col-sm-12">
                            <table>
                                <tr>
                                    <td>
                                        <span style="font-size: 16px; font-weight: bold; padding-left: 5px;line-height:42px;">Customer:</span>
                    ...
                    <div class="row">
                        <div class="ol-lg-12  col-sm-12">
                            <table>
                                <tr>
                                    <td>
                                        <span style="font-size: 16px; font-weight: bold; padding-left: 5px; line-height:42px;">Section:</span>
                                    </td>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <asp:Panel ID="pnlStartClock" runat="server">
                                ...
                                <div style="color:#1574c4; font-size:16px; font-weight:bold;" class="col-xs-6 col-sm-6 col-md-3 col-lg-2">
                                    Start Time: 
                        ...
                        <div class="form-group" runat="server" id="pnlEndButton" visible="false">
                            <asp:Panel ID="pnlEndClock" runat="server">
                                ...
                                <div style="color:#0f2b69; font-size:16px; font-weight:bold;" class="col-xs-6 col-sm-6 col-md-3 col-lg-2">
                                    End Time:
