    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                {
                    string ss = Request.QueryString.Keys[0];
                ...
                else
                {
                    ...
                    exportReport(rptFile, CrystalDecisions.Shared.ExportFormatType.WordForWindows);
                }
    ...
    protected void exportReport(CrystalDecisions.CrystalReports.Engine.ReportDocument selectedReport, CrystalDecisions.Shared.ExportFormatType eft)
    {
        ...
        switch (eft)
        {
            ...
            case CrystalDecisions.Shared.ExportFormatType.WordForWindows:
                ...
                tempFileName += DateTime.Now.Ticks.ToString() + ".doc";
                  sPage = "pdf_report/" + DateTime.Now.Ticks.ToString() + ".doc";
