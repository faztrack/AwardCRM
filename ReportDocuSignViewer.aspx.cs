...
public partial class ReportDocuSignViewer : System.Web.UI.Page
{
    ...
    protected void exportReport(CrystalDecisions.CrystalReports.Engine.ReportDocument selectedReport, CrystalDecisions.Shared.ExportFormatType eft)
    {
        ...
        customer cust = _db.customers.Single(c => c.customer_id == Convert.ToInt32(hdnCustomerId.Value));
        ...
        string strCustomerEstimateId = hdnCustomerId.Value + "_" + hdnEstimateId.Value + "_" + Convert.ToInt32(ConfigurationManager.AppSettings["client_id"]);
    ...
    void WriteSignature(string email, string first_name, string last_name, string file_name)
    {
        ...
        tabs = new LinkedTab[]
                            {   //LinkedTab.CreateTab(signer, "E-mail", Request.Form["Email"], "E-mail:", 200, -2),
                                ...
                                LinkedTab.CreateTab(Signing.DocuSignWeb.TabTypeCode.SignHere,signer, "Owner / Purchaser", -10, -40),
                                LinkedTab.CreateTab(Signing.DocuSignWeb.TabTypeCode.DateSigned,signer, "Owner / Purchaser", -10, -18),
        ...
        doc = MakeDocument("ContractDoc", Server.MapPath(@"Reports\Common\tmp\" + file_name));
        doc.Tabs = tabs;
        ...
        try
        {
            ...
            string ss = envelope.RetrieveStatus().ToString();
        }
        ...
        string retUrl = Request.Url.AbsoluteUri.Replace("ReportDocuSignViewer.aspx", "SigningReturn.aspx");
