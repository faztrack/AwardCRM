<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="customermessagecenteroutlook.aspx.cs" Inherits="customermessagecenteroutlook" Title="Customer Message Center" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                                ...
                                                <td class="wrapper" align="left" colspan="4">
                                                    ...
                                                    <asp:Panel ID="pnlIntialeMail" runat="server" Height="100%">
                                                        <table class="newWrapper" cellpadding="2" cellspacing="2" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align='left'>From all of us in Award KB, we would like to thank you for giving us the </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td align='left'>Award KB is a family owned and operated, five star rated, licensed, bonded  </td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <td class="wrapper" align="left" colspan="4">
                                                    ...
                                                    <asp:Panel ID="pnlfolloweMail2" runat="server" Height="100%">
                                                        <table class="newWrapper" cellpadding="2" cellspacing="2" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align='left'>Hello from  Award KB!</td>
                                                            </tr>
                                                            <tr>
                                                                <td align='left'>&nbsp;</td>
                                                            </tr>
                                ...
                                <asp:HiddenField ID="hdnCompanyEmail" runat="server" Value="" />
