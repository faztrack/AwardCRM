...
public partial class companyprofile : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (_db.company_profiles.Where(cp => cp.client_id == Convert.ToInt32(hdnClientId.Value)).SingleOrDefault() != null)
            {
                ...
                txtCOEmail.Text = com.co_email;
                txtWebsite.Text = com.website;
                //txtMarkup.Text = com.markup.ToString();
                txtFinance.Text = com.FinancePer.ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (txtFinance.Text.Trim()!= "")
            com.FinancePer = Convert.ToDecimal(txtFinance.Text.Trim());
        else
            com.FinancePer = 0;
