    ...
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-ext">
            ...
            <h3 class="panel-title">
                <asp:ImageButton ID="imgBack" runat="server" OnClick="imgBack_Click" ImageUrl="~/assets/mobileicons/back_header_project_calendar.png" Style="margin-bottom: -10px;height:32px;" />
