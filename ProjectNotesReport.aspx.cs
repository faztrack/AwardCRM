...
public partial class ProjectNotesReport : System.Web.UI.Page
{
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, grdProjectNote.ID, grdProjectNote.GetType().Name, "PageIndexChanging"); 
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, txtProjectStartDate.ID, txtProjectStartDate.GetType().Name, "TextChanged"); 
        LoadProjectNoteInfo(0, "");;
    }
    protected void txtProjectEndDate_TextChanged(object sender, EventArgs e)
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, txtProjectEndDate.ID, txtProjectEndDate.GetType().Name, "TextChanged"); 
        LoadProjectNoteInfo(0, "");;
    }
