...
public partial class schedulecalendar : System.Web.UI.Page
{
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, chkEst.ID, chkEst.GetType().Name, "Click"); 
        int nCustId = Convert.ToInt32(hdnCustomerID.Value);
        int nEstId = 0;// Convert.ToInt32(ddlEst.SelectedItem.Value);
    ...
    public static string UpdateEvent(ImproperCalendarEvent cevent)
    {
        ...
        if (idList != null && idList.Contains(cevent.id))
        {
            ...
            {
                nCheck = EventDAO.updateEvent(cevent.id, cevent.title, cevent.section_name, cevent.location_name, cevent.description,
                     ...
                     cevent.parentDependencyType, cevent.parentOffsetDays, cevent.linkType, cevent.customer_id, cevent.estimate_id, cevent.IsScheduleDayException, cevent.is_complete);
        ...
        try
        {
            ...
            if (idList != null && idList.Contains(improperEvent.id))
            {
                EventDAO.updateEventTime(improperEvent.id,
                    ...
                    DateTime.ParseExact(ndt.ToString(), "dd-MM-yyyy hh:mm:ss tt", CultureInfo.InvariantCulture),
                      improperEvent.customer_id, improperEvent.estimate_id, improperEvent.IsScheduleDayException);
    ...
    public static int addEvent(ImproperCalendarEvent improperEvent)
    {
        ...
        CalendarEvent cevent = new CalendarEvent()
        {
            ...
            section_name = improperEvent.section_name,
            location_name = improperEvent.location_name,
