    ...
    <table cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <td align="left">
                                                         <asp:Panel ID="Panel2" runat="server">
                                                            <span id="PnlCtrlID" runat="server">
                                                                <asp:LinkButton ID="lnkAddNewCall" runat="server" CssClass="button" Width="160px">
        ...
        <tr>
            <td align="center">
                ...
                <asp:HyperLink ID="hypSelectionLog" runat="server" CssClass="button">Selection Log</asp:HyperLink>
            </td>
        </tr>
    </table>
