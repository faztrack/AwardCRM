                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading panel-heading-ext">
                            ...
                            <h3 class="panel-title">
                                <asp:ImageButton ID="imgBack" runat="server" OnClick="imgBack_Click" ImageUrl="~/assets/mobileicons/back_header_add_new_lead.png" Style="margin-bottom: -10px;height:32px;" />
                                                ...
                                                <ItemTemplate>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12">
                                                           ...
                                                           <asp:HyperLink ID="hyp_SiteReview" runat="server"><img width="40" height="40" src="assets/mobileicons/12-Site-review-List.png" alt="Site Review" title="Site Review" class="divImageCssM" /></asp:HyperLink>
                                                           <asp:HyperLink ID="hyp_DocumentManagement" runat="server"><img width="40" height="40" src="assets/mobileicons/13-Documents.png" alt="Document Management" title="Document Management" class="divImageCssM" /></asp:HyperLink>
                                                           <asp:HyperLink ID="hypProjectNotes" runat="server"><img width="40" height="40" src="assets/mobileicons/07-Project-Notes.png" alt="Project Notes" title="Project Notes" class="divImageCssM" /></asp:HyperLink>
                                                        </div>
                                                    </div>
                                                </ItemTemplate>
