...
public partial class ChangeOrderListAll : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Page.User.IsInRole("GenCOList001") == false)
            {
                // No Permission Page.
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, grdCustCOList.ID, grdCustCOList.GetType().Name, "PageIndexChanging"); 
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, grdCustCOList.ID, grdCustCOList.GetType().Name, "Sorting"); 
        int nPageNo = 0;
