...
public partial class payment_recieved : System.Web.UI.Page
{
    ...
    string CreateHtml()
    {
        ...
        TABLE += "<table cellpadding='0' cellspacing='2' width='100%' style='margin: 0 auto;font-family:Arial, Helvetica, sans-serif;'>" +
             "<tr style='color:#555; font-size:14px; line-height:24px;'><td align='left'>To make your payment online, please click <a target='_blank' href='https://awardkb.faztrack.com/customerlogin.aspx'> here </a></td></tr>" +
