<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="NewSectionManagement.aspx.cs"
    MaintainScrollPositionOnPostback="true" Inherits="NewSectionManagement" Title="Section Management" %>
                                        ...
                                        <tr>
                                            <td style="background-color: #eaeff9;" align="center" colspan="2">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td align="right">&nbsp;<asp:Button ID="btnAddSubnewRow" runat="server" CssClass="button" OnClick="btnAddSubnewRow_Click" Text="Add New Sub Section" Visible="False" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center">
                                        ...
                                        <tr>
                                            <td style="background-color: #bcc6dd;" align="center" colspan="2">
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="right">
                                                            <asp:Button ID="btnDisable" runat="server" CssClass="button" OnClick="btnDisable_Click" Text="Disable Item" Visible="False" />
