            ...
            <div class="panel panel-default">
               <div class="panel-heading panel-heading-ext">
                    <h3 class="panel-title">
                        <asp:ImageButton ID="imgBack" runat="server" OnClick="imgBack_Click" ImageUrl="~/assets/mobileicons/back_header_project_notes.png" Style="margin-bottom: -10px;height:32px;" />
                        ...
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <table cellpadding="0" cellspacing="2" width="100%" align="center">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <b style="font-size:12px">Please click OK to send the Project Notes email.</b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
